...
public class RubyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        position.x = position.x + 0.1f; //Here you are accessing the x value, which is the horizontal position. To move your GameObject slightly to the right, you have added 0.1 to the x value and stored the result back into x. 
